  ...
  s.subspec 'Social' do |ss|
      ...
      ss.subspec 'UI' do |sss|
          sss.resource_bundles = {
              'UI' => ['UUShareCommonLib/Classes/SocialLibraries/UI/*.bundle']
          }
          sss.vendored_frameworks = 'UUShareCommonLib/Classes/SocialLibraries/UI/*.framework'
          sss.dependency "UUShareCommonLib/UMShare"
      end
  end
  s.subspec 'Common' do |c|
      c.source_files = 'UUShareCommonLib/Classes/UUUShare/*'
      c.dependency 'UUShareCommonLib/Social'
  end
